...
The new mean is equal to the one in the first part of the assignment and the new median does differ. Na's where changed to the mean of the interval and so, as we have several days without recording, the mean of those days is the same as the mean of the hole dataset.
